...
const InputArea = () => {
  ...
  const { handleSend, selectedFile, setSelectedFile, setFile } =
        ...
        <div className="flex items-center space-x-2">
          <div className="relative bottom-3 left-5">
            <div className="absolute">
              ...
              {selectedFile && (
                <FileInfoPopup file={selectedFile} onClose={handleClosePopup} />
              )}
            </div>
          </div>
          <Input
          ...
          <div className="relative right-14 bottom-5 flex">
            <Button
              className="absolute rounded-full w-10 h-10 bg-transparent hover:bg-transparent cursor-pointer z-20 text-primary"
              onClick={handleSendController}
